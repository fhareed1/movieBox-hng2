    ...
    <div className="flex flex-col justify-center items-center m-12">
      ...
      <IconContext.Provider value={{ className: "w-6 h-7" }}>
        <div className="flex justify-between w-60 mb-6">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/fhareed_/" target="_blank">
            <AiOutlineInstagram />
          </a>
          {/* Twitter */}
          <a href="https://twitter.com/codedFareed" target="_blank">
            <AiOutlineTwitter />
          </a>
          {/* Youtube */}
          <a href="https://fhareed1.github.io/Folorunsho-porfolio/" target="_blank">
            <AiFillYoutube />
          </a>
        </div>
      ...
      <div>
        <h1 className="text-lg font-[#6B7280]">
          &copy; 2023 MovieBox by Folorunsho Fareed
        </h1>
      </div>
    </div>
  );
